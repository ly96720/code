<template>
  <div>
    <van-swipe class="box"
               v-if="data2[0].moduleContent.banners"
               :autoplay="3000"
               indicator-color="white">
      <van-swipe-item v-for="(item,index) in data2[0].moduleContent.banners"
                      :key="index">
        <img :src="item.bannerImgSrc"
             alt="">
      </van-swipe-item>
    </van-swipe>
    <h1 class="h1">{{data2[1].moduleName}}</h1>
    <h3 class="h3">{{data2[1].moduleDescription}}</h3>
    ...
    <h1 class="h1">{{data2[2].moduleName}}</h1>
    <h3 class="h3">{{data2[2].moduleDescription}}</h3>
    <div class="main">
      <dl v-for="(item,index) in data2[2].moduleContent.products"
          :key="index">
        <img :src="item.productImg"
             alt="">
    ...
    <h1 class="h1">{{data2[3].moduleName}}</h1>
    <h3 class="h3">{{data2[3].moduleDescription}}</h3>
    <div class="main">
      <dl v-for="(item,index) in data2[3].moduleContent.products"
          :key="index">
        <img :src="item.productImg"
             alt="">
        <dd>{{item.productTitle}}</dd>
    ...
    <div class="hot">
      <img :src="item.bannerImgSrc"
           alt=""
           v-for="(item,index) in data2[4].moduleContent.banners"
           :key='index'>
    </div>
